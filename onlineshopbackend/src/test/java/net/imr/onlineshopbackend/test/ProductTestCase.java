package net.imr.onlineshopbackend.test;
...
private static AnnotationConfigApplicationContext context;
	...
	public static void init(){
		...
		context.scan("net.imr.onlineshopbackend");
		context.refresh();
...
/*	
	...
	public void testCRUDProduct(){
		...
		product.setDescription("This is the best available Oppo Mobile in the Market!");
		...
		product.setName("Samsang Galaxy S7");
		...
		//fetching the list
		assertEquals("Something went wrong while fetching the list ofproducts!",6,productDAO.list().size());
	...
	*/
	...
	public void testListActiveProducts() {
		//fetching the list
				assertEquals("Something went wrong while fetching the list ofproducts!",
